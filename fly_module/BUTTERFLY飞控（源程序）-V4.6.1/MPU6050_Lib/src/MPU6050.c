...
//前后偏差，减小这个值向后偏
#define roll_angel_offset_ByINSPAIRE  0
//左右检查，加大下面的值会向左偏
#define pitch_angel_offset_ByINSPAIRE  0//初始时固定偏移
...
//	float temp;
	...
	**/
    ...
    /*
	  ...
	  w_and_angle.angle_roll = Roll+roll_angel_offset+roll_angel_offset_ByINSPAIRE; 		//横滚角度
		w_and_angle.angle_pitch = Pitch+pitch_angel_offset+pitch_angel_offset_ByINSPAIRE;	//俯仰角度
